...
class Test_MemberMiningReceipts(unittest.TestCase):
    """"""
    def setUp(self):
        self.test_driver = ma_driver_eng()
        self.test_driver.login()
        self.test_driver.side_select(text='報表管理')
        self.test_driver.func_select(text='會員礦機領取紀錄')
    ...
    def test_select_type_mid(self):
        ...
        res = self.test_driver.driver.find_element(By.XPATH,
                                                   '//table[@class="el-table__body"]/tbody/tr/td[2]/div/div/span').text
    ...
    def test_select_type_nickname(self):
        ...
        self.test_driver.search_button()
        res = self.test_driver.driver.find_element(By.XPATH,
                                                   '//table[@class="el-table__body"]/tbody/tr/td[4]/div/div/span').text
        self.assertEqual('  ', res)
    ...
    def test_select_type_phone(self):
        ...
        self.test_driver.search_button()
        res = self.test_driver.driver.find_element(By.XPATH,
                                                   '//table[@class="el-table__body"]/tbody/tr/td[3]/div/div/span').text
        self.assertEqual('', res)
