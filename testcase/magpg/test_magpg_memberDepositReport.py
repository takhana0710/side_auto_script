...
class Test_MemberDeposit(unittest.TestCase):
    ...
    def test_select_type_nickname(self):
        ...
        res = self.test_driver.driver.find_element(By.XPATH,
                                                   '//table[@class="el-table__body"]/tbody/tr/td[4]/div/span').text
    ...
    def test_select_type_phone(self):
        ...
        self.test_driver.search_button()
        res = self.test_driver.driver.find_element(By.XPATH,
                                                   '//table[@class="el-table__body"]/tbody/tr/td[3]/div/span').text
        self.assertEqual('  ', res)
